...
namespace WPFApplication.Core
{
    ...
    {
        private const int MONITOR_DEFAULT_TO_NEAREST = 0x00000002;
        ...
        private static void WmGetMinMaxInfo(IntPtr hwnd, IntPtr lParam)
        {
            ...
            IntPtr monitorContainingApplication = MonitorFromWindow(hwnd, MONITOR_DEFAULT_TO_NEAREST);
        ...
        private static MINMAXINFO AdjustWorkingAreaForAutoHide(IntPtr monitorContainingApplication, MINMAXINFO mmi)
        {
            ...
            IntPtr monitorWithTaskbarOnIt = MonitorFromWindow(hwnd, MONITOR_DEFAULT_TO_NEAREST);
